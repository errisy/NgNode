...
declare module "browser-sync" {
    //imports must be embedded inside the module!
    import * as fs from "fs";
    import * as http from "http";
    export interface IBrowserSyncModule {
        exports: Options;
    }
    ...
    export interface Options {
        ...
        middleware?: MiddlewareHandler | PerRouteMiddleware | (MiddlewareHandler | PerRouteMiddleware)[] | IMiddleware;
    }
    ...
    export type Pattern = (string | RegExp | MatchFunction<string>);
    ...
    export interface IMiddleware {
        [id: number]: MiddlewareHandler | PerRouteMiddleware;
    }
    ...
    export interface PerRouteMiddleware {
        route: string;
    ...
    export interface BrowserSyncStatic extends BrowserSyncInstance {
        /**
    ...
    export interface BrowserSyncInstance {
        ...
        /**
            ...
            */
        watch(patterns: string, opts?: IWatchOptions, fn?: (event: string, file: fs.Stats) => any)
            : NodeJS.EventEmitter;
        /**
